...
static const unsigned int gappoh = 10; /* horiz outer gap between windows and screen edges */
static const unsigned int gappov = 10; /* horiz outer gap between windows and screen edges */
...
/* commands */
static const char *dmenucmd[] = {"dmenu_run", "-fn", dmenufont, "-nb", col_gray1,   "-nf", col_gray3, "-sb", col_gray2,   "-sf", col_gray1, NULL};
...
static const Key keys[] = {
    ...
    {MODKEY | ControlMask | ShiftMask,        XK_k,                     incgap,         {.i = 10}},
    {MODKEY | ControlMask | ShiftMask,        XK_j,                     decgap,         {.i = 10}},
    TAGKEYS(XK_1, 0)
    TAGKEYS(XK_2, 1)
    TAGKEYS(XK_3, 2)
    TAGKEYS(XK_4, 3)
